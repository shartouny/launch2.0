...
use SunriseIntegration\Shopify\Http\Request;
use SunriseIntegration\Shopify\Http\Client;
...
abstract class AbstractEntity implements \JsonSerializable, \ArrayAccess
{
    ...
    /**
     * @var \SunriseIntegration\Shopify\Http\Client
     */
    private $request;

    /**
     * @var \SunriseIntegration\Shopify\Models\Auth
     */
    private $apiAuthorization = null;

    /**
     * @return \SunriseIntegration\Shopify\Models\Auth null
     */
    ...
    /**
     * @param \SunriseIntegration\Shopify\Models\Auth $apiAuthorization
     *
     * @return $this
     */
     ...
     *
     * @param Auth $auth credentials for connection to shopify
     * @throws \RuntimeException
     */
    public function __construct(\SunriseIntegration\Shopify\Models\Auth $auth = null,$data = null)
    {
        if ($auth !== null) {
    ...
    protected function getRequestData($endpoint, $query = null)
    {
        ...
        $request->setHeaders([
            ...
            'X-Shopify-Access-Token: ' . $this->getApiAuthorization()->getPassword(),
        ]);
    ...
    public function toArray()
    {
        ...
        foreach ($properties as $key => $value) {
            ...
            if ($key === '_data' || $key === 'request' || $key === 'apiAuthorization') {
